...
export const DESIGNATION_LIST = "designation-list"
export const ADD_DESIGNATION = "add-designation"
export const EDIT_DESIGNATION = "edit-designation"
...
export const LEVEL_LIST = "level-list"
...
export const CALENDER_LIST = "calendar-list"
