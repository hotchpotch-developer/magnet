            ...
            <div className="col-lg-12">
                <div className="card joblist-card">
                    <div className="card-body">
                        ...
                        <div>
                            <span className="badge bg-primary-subtle text-primary me-1">{item.product.label}</span>
                            <span className="badge bg-primary-subtle text-primary me-1">{item.industry.label}</span>
                            <span className="badge bg-primary-subtle text-primary me-1">{item.department.label}</span>
                    ...
                    <div className="card-footer border-top-dashed">
                        <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
                            <div>
                                ...
                                <span className="job-type">{item.state_name.label}</span>
                            </div>
                            <div className="d-none">
                                <span className="job-experience">{item.sales_non.label}</span>
                            </div>
                            <div>
                                <i className="ri-map-pin-2-line align-bottom me-1"></i>
                                <span className="job-location">{item.location.label}</span>
                            </div>
                            <div>
                            ...
                            <div>
                                <Link to="/edit-job" state={item} className="btn btn-primary viewjob-list">Edit Job <i className="ri-arrow-right-line align-bottom ms-1"></i></Link>
                            </div>
                        </div>
                    </div>
                </div>
